...
% Box\Research\Code\Anthony's Codebase\For Andy\Carreon Program Files\Europa Model Inputs

function irr = sunIrradianceEuropa(wL,wU)
%       Return the spectral irradiance of a black body at the given
%   temperature in the given wavelength bounds at the given distance R (in
%   astronomical units). Sample nP points for the irradiance.
    ...
    rE = 1.496e11; % [m] distance from sun to Earth
    rB = rE*5.2; % [m] distance from sun to Europa
    nP = 1e5; % number of data points
