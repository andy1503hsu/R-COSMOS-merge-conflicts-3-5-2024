function [aData, eData, energyData] = planetarySimulate(sData, photons) %#codegen
    ...
    if thermalStart == 1  % Solar photons weren't simulated
    ...
    else % Convert solar absorption from cell array to 2D matrix
        ...
        % Only save non-zero entries in exitance matrix
    ...
    else % Each facet's thermal absorption corresponds to a different cell
        aEventsThermal = cell(numFacets, 1);
