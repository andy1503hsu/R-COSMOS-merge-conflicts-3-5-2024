...
function [aData, eData, energyData] = planetarySimulateThermalExitance(sData, photons) %#codegen
    ...
    thermalAbsorbed = sum(energyAbsorbedPerPhoton);
    eDataThermal = eDataAll(thermalStart:end, :);
    eData.thermal = eDataThermal(eDataThermal(thermalStart:end, 2) ~= 0, :);
